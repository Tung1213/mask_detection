...
if __name__ == "__main__":
    ...
    net = load_net("yolov4_data/yolov4-tiny-obj.cfg".encode('utf-8'), "yolov4_data/yolov4-tiny-obj_final.weights".encode('utf-8'), 0)
    meta = load_meta("yolov4_data/coco.data".encode('utf-8'))
    # 测试数据集的路径
    test_dir = 'test/1.jpg'
    # 检测结果保存路径
    save_dir = 'save/'
